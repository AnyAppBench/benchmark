...
- Available Apps: `["Camera","Chrome","Clock","Contacts","Google Contacts","Fossify Contacts","Connect You","Simple Contacts Pro SE","Right Contact","Dialer","Files","Material Files","Amaze File Manager","Fossify File Manager","Total Commander","X-plore File Manager","Settings","Markor","Tasks","Simple Draw Pro","Simple Gallery Pro","Simple SMS Messenger","Fossify Messages","QUIK SMS","Messages","Audio Recorder","Pro Expense","Broccoli APP","OSMand","Organic Maps","Google Maps","CoMaps","MAPS.ME","VLC","Joplin","Retro Music","OpenTracks","Simple Calendar Pro","Simple Clock","Google Clock","Clock You","Chrono","Fossify Clock"]`.
...
## Note
- Available Apps: `["Contacts","Google Contacts","Fossify Contacts","Connect You","Simple Contacts Pro SE","Right Contact","Settings","Clock","Simple Clock","Google Clock","Clock You","Chrono","Fossify Clock","Maps","OSMand","Organic Maps","Google Maps","CoMaps","MAPS.ME","Chrome","Calendar","Simple Calendar Pro","files","Material Files","Amaze File Manager","Fossify File Manager","Total Commander","X-plore File Manager","Gallery","Simple SMS Messenger","Fossify Messages","QUIK SMS","Messages","Camera"]`.
- Write a small plan and finally summarize your next action (with its target element) in one sentence in <thinking></thinking> part.
""".strip()
)
