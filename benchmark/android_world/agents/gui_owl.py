...
all_apps_str = """- simple calendar pro: A calendar app.
  ...
  - clock: An app with alarm, stopwatch, timer, and world clock functionality.
  - simple clock: A clock app.
  - google clock: A clock app.
  - clock you: A clock app.
  - chrono: A clock and timer app.
  - fossify clock: A clock app.
  ...
  - google contacts: A contacts app.
  - fossify contacts: A contacts app.
  - connect you: A contacts app.
  - simple contacts pro se: A contacts app.
  - right contact: A contacts app.
  - osmand: A maps and navigation app with support for adding location markers, favorites, and saving tracks.
  - organic maps: A maps and navigation app.
  - google maps: A maps and navigation app.
  - comaps: A maps and navigation app.
  - maps.me: A maps and navigation app.
  ...
  - material files: A file manager app.
  - amaze file manager: A file manager app.
  - fossify file manager: A file manager app.
  - total commander: A file manager app.
  - x-plore file manager: A file manager app.
