...
class AddContact(task_eval.TaskEval):
  ...
  def is_successful(self, env: interface.AsyncEnv) -> float:
    ...
    contact_found = self._has_contact(actual_contacts)
    
    print(f"[DEBUG] Expected contact: {expected_contact}")
    print(f"[DEBUG] Found contacts: {actual_contacts}")
    print(f"[DEBUG] Contact match: {contact_found}")
