...
_DEVICE_FILES = '/data/media/0/Android/data/net.osmand.plus/files'
_LEGACY_FILES = '/data/data/net.osmand.plus/files'
...
class OsmAndMarker(_OsmTaskEval, sqlite_validators.SQLiteApp):
  ...
  db_path = '/data/data/net.osmand.plus/databases/map_markers_db'
  db_key = 'marker_id'
